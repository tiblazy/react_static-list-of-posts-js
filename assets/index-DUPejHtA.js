...
expedita consequatur consequatur dolores quia eos et placeat`}],Nc=[{id:1,name:"Leanne Graham",username:"Bret",email:"Sincere@april.biz"},{id:2,name:"Ervin Howell",username:"Antonette",email:"Shanna@melissa.tv"},{id:3,name:"Clementine Bauch",username:"Samantha",email:"Nathan@yesenia.net"},{id:4,name:"Patricia Lebsack",username:"Karianne",email:"Julianne.OConner@kory.org"},{id:5,name:"Chelsey Dietrich",username:"Kamren",email:"Lucio_Hettinger@annie.ca"},{id:6,name:"Mrs. Dennis Schulist",username:"Leopoldo_Corkery",email:"Karley_Dach@jasper.info"},{id:7,name:"Kurtis Weissnat",username:"Elwyn.Skiles",email:"Telly.Hoeger@billy.biz"},{id:8,name:"Nicholas Runolfsdottir V",username:"Maxime_Nienow",email:"Sherwood@rosamond.me"},{id:9,name:"Glenna Reichert",username:"Delphine",email:"Chaim_McDermott@dana.io"},{id:10,name:"Clementina DuBuque",username:"Moriah.Stanton",email:"Rey.Padberg@karina.biz"}],Pc=({comment:e})=>B.jsxs("div",{className:"CommentInfo",children:[B.jsxs("div",{className:"CommentInfo__title",children:[B.jsx("strong",{className:"CommentInfo__name",children:e.name})," by ",B.jsx("a",{className:"CommentInfo__email",href:`mailto:${e.email}`,children:e.email})]}),B.jsx("div",{className:"CommentInfo__body",children:e.body})]},e.id),Lc=({comments:e})=>B.jsx("div",{className:"CommentList",children:e.map(t=>B.jsx(Pc,{comment:t}))}),Tc=({user:e})=>B.jsx("a",{className:"UserInfo",href:`mailto:${e.email}`,children:e.name}),Mc=({post:e})=>B.jsxs("div",{className:"PostInfo",children:[B.jsxs("div",{className:"PostInfo__header",children:[B.jsx("h3",{className:"PostInfo__title",children:e.title}),B.jsxs("p",{children:[" Posted by  ",B.jsx(Tc,{user:e.user})]})]}),B.jsx("p",{className:"PostInfo__body",children:e.body}),e.comments.length>0?B.jsx(Lc,{comments:e.comments}):B.jsx("b",{"data-cy":"NoCommentsMessage",children:"No comments yet"})]},e.id),Rc=({posts:e})=>B.jsx("div",{className:"PostList",children:e.map(t=>B.jsx(Mc,{post:t}))}),Dc=e=>Nc.filter(t=>t.id===e),jc=e=>Cc.filter(t=>t.postId===e),Oc=zc.map(e=>({...e,user:Dc(e.userId),comments:jc(e.id)})),Fc=()=>B.jsxs("section",{className:"App",children:[B.jsx("h1",{className:"App__title",children:"Static list of posts"}),B.jsx(Rc,{posts:Oc})]});em(document.getElementById("root")).render(B.jsx(Fc,{}));
